...
module.exports = (sequelize) => {
    const Company = sequelize.define('Company', {
        ...
        nombre_contacto: { type: DataTypes.STRING, allowNull: true },
        cargo: { type: DataTypes.STRING, allowNull: true },
        giro_empresa: { type: DataTypes.STRING, allowNull: true },
        ...
        genero_preferente: { type: DataTypes.STRING, allowNull: true },
